...
exports.ESNEXT_RULES = [
    'no-var', 'arrow-parens', 'arrow-spacing', 'constructor-super', 'generator-star-spacing', 'no-duplicate-imports',
    'no-arrow-condition', 'prefer-rest-params', 'no-const-assign', 'no-dupe-class-members', 'no-this-before-super',
    'fecs-jsx-var', 'fecs-esnext-ext', 'no-class-assign', 'fecs-use-method-definition', 'fecs-use-property-shorthand',
    'fecs-prefer-class', 'fecs-prefer-super', 'fecs-export-on-declare', 'fecs-imports-on-top', 'fecs-valid-super',
    'fecs-arrow-body-style', 'fecs-max-destructure-depth', 'fecs-min-vars-per-destructure', 'fecs-one-var-per-line',
    'fecs-no-anonymous-before-rest', 'fecs-max-calls-in-template', 'fecs-no-extra-destructure',
    'fecs-use-standard-promise', 'fecs-use-for-of', 'fecs-prefer-spread-element'
];
