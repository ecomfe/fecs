...
exports.ESNEXT_RULES = [
    ...
    'no-var', 'fecs-esnext-ext', 'fecs-no-arguments', 'fecs-use-method-definition', 'fecs-use-property-shorthand',
    'fecs-prefer-class', 'fecs-prefer-super', 'fecs-export-on-declare', 'fecs-imports-on-top'
];
...
exports.parse = function (text, config, path) {
    ...
    try {
        ...
        if (message === '\'import\' and \'export\' may only appear at the top level') {
            e.rule = 'fecs-import-on-top';
        }
