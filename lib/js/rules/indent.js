...
module.exports = function (context) {
    ...
    var isHTMLStrings = function (node) {
        ...
        node.elements.forEach(function (el) {
            ...
            if (lastElement && lastElement.loc.start.line === el.loc.start.line) {
                return;
            }
        ...
        var validTypes = 'Literal,BinaryExpression,Identifier,CallExpression,ConditionalExpression'.split(',');
        var total = 0;
        ...
        if (comments && /\bhtml\b/.test(comments[0].value) || total === node.elements.length) {
