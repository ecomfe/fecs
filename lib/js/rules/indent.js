...
module.exports = function (context) {
    ...
    var getNodeIndent = function (node, byLastLine, excludeCommas) {
            ...
            if (indentType === 'spaces') {
                ...
                if (tabReg.test(src) && !tabLineMap[loc.line]) {
                    ...
                    context.report(node, loc, 'Expected spaces but saw tabs.');
                }
     ...
     * @param {number=} [switchIndent] indent for switch statement
    ...
    function expectedCaseIndent(node, switchIndent) {
        ...
        caseIndent = switchIndent + (indentSwitchCase ? indentSize : 0);
