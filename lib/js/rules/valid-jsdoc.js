...
module.exports = function (context) {
    ...
    function getParamName(node, docNode) {
        ...
        switch (type) {
            ...
            case 'ObjectPattern':
                return docNode && docNode.type.name === 'Object' ? docNode.name : '';
        ...
        if (jsdocNode) {
            ...
            if (startLine > 2) {
                ...
                if (!/^\s*$/.test(codeBeforeLine)) {
                    context.report(jsdocNode, 'Before JSDoc comment there must be an empty line.baidu041');
                }
            }
            ...
            if (paramType !== 'Array') {
                ...
                if (param.type === 'RestElement'
                    ...
                    context.report(
                        ...
                        'Expected an Array type for rest parameter "{{name}}"',
                        {name: key}
                    );
                }
            }
