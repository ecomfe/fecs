...
module.exports = function (context) {
     ...
     * @return {boolean} Whether or not there is space between the tokens.
     */
     ...
     * @return {boolean} True if the tokens are on the same line, false if not.
     * @private
     */
     ...
     * @return {boolean} True if the given token has leading space, false if not.
     */
     ...
     *
     * @param {Object} token The token to check.
     * @return {boolean} True if the given token has trailing space, false if not.
     */
     ...
     * @return {boolean} Whether or not the token is the last in its line.
     */
     ...
     *
     * @param {Token} token The token to check.
     * @return {boolean} Whether or not the given token is a semicolon.
     */
    ...
    return {
        ...
        ForStatement: function (node) {
            ...
            if (node.test) {
                if (!node.update && requireSpaceAfter) {
                    return;
                }
