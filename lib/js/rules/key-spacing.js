...
function getKeyWidth(property) {
    ...
    if (property.computed || property.type === 'SpreadProperty') {
        var fix = (property.type === 'SpreadProperty' || property._babelType === 'SpreadProperty') ? 3 : 2;
        return key.end - key.start + fix;
    }
