...
exports.isArrayNode = function (context) {
    return function isArrayNode(node) {
        switch (node.type) {
            case 'Identifier':
                if (node.parent) {
                ...
                var variable;
                context.getScope().variables.some(function (item) {
                ...
                return variable.references.reduceRight(function (result, ref) {
                    if (!result && ref.writeExpr) {
                        result = isArrayNode(ref.writeExpr);
                    }
                    return result;
                }, false);
...
exports.isObjectNode = function (context) {
    ...
    return function isObjectNode(node) {
        if (isArray(node)) {
            return false;
        }
        ...
        switch (type) {
            ...
            case 'Identifier':
                ...
                return variable.references.reduceRight(function (result, ref) {
                    if (!result && ref.writeExpr) {
                        result = isObjectNode(ref.writeExpr);
                    }
                    return result;
                }, false);
